/*
  Copied from the new std.internal.scopebuffer from Phobos.
  The only change I made was the name of the module (so the compiler
  would compile it), and making opSlice inout so I could use it
